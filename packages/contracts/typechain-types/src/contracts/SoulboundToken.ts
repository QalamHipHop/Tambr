...
export namespace IssuedEvent {
  ...
  export type OutputTuple = [tokenId: bigint, to: string, metadata: string];
  export interface OutputObject {
    tokenId: bigint;
    to: string;
    metadata: string;
...
export interface SoulboundToken extends BaseContract {
  ...
  tokenMetadata: TypedContractMethod<[arg0: BigNumberish], [string], "view">;
  ...
  filters: {
    ...
    "Issued(uint256,address,string)": TypedContractEvent<
      IssuedEvent.InputTuple,
      IssuedEvent.OutputTuple,
      IssuedEvent.OutputObject
    >;
