...
export interface GovernanceTokenInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "getFounderAllocationPercentage",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface GovernanceToken extends BaseContract {
  ...
  getFounderAllocationPercentage: TypedContractMethod<[], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "getFounderAllocationPercentage"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  filters: {
    ...
    "FounderAllocationSet(address,uint256)": TypedContractEvent<
      ...
      FounderAllocationSetEvent.OutputObject
    >;
    FounderAllocationSet: TypedContractEvent<
      FounderAllocationSetEvent.InputTuple,
      FounderAllocationSetEvent.OutputTuple,
      FounderAllocationSetEvent.OutputObject
    >;
